<?php
  ...
  $pullingMenuCode = "";
  if (isset($_POST['edit'])) {
    $pullingMenuCode = "SELECT * FROM menus WHERE menuName ='" . $_POST['hiddenText'] . "'";
  }
  if (isset($_POST['calSubmit'])) {
    $pullingMenuCode = "SELECT * FROM menus WHERE basketID ='" . $_POST['basketNum'] . "'";
  }
  $menuNumber = 0;
  $amountNeeded = 0;
        ...
        <div class="selection-form">
          ...
          <p>Menu Name</p>
            <?php
              ...
              echo '<input type="text" id="food" name="newMenuName" placeholder="Menu Name" value="' . $row['menuName'] . '">';
            ?>
            <p>Items</p>
          </div>
          <ul>
